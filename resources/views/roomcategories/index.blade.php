                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="card">
                      ...
                      <div class="card-body">
                        <form action="/roomcategories" method="POST">
                            @csrf
                          <div class="mb-6">
                          ...
                          <div class="mb-6">
                            ...
                            <div class="input-group input-group-merge">
                              <input type="text" id="price" name="price" class="form-control" placeholder="100" aria-label="100" aria-describedby="room-price-addon">
                          ...
                          <div class="mb-6">
                            ...
                            <input type="text" class="form-control" id="room_size" name="room_size" placeholder="30 sqm">
                          </div>
                          <div class="mb-6">
                            <label class="form-label" for="capacity">Capacity</label>
                            <input type="text" class="form-control" id="capacity" name="capacity" placeholder="2">
                          </div>
                          <div class="mb-6">
                            ...
                            <tbody>
                                @foreach ($roomcategories as $RC)
                                    <tr>
                                        ...
                                        <td>{{ $RC->bed_setup }}</td>
                                        <td class="d-flex">
                                            <a href="/roomcategories/{{ $RC->id }}/edit" class="btn btn-warning btn-sm">Edit</a>
                                            &nbsp;
                                            <form action="/roomcategories/{{ $RC->id }}" method="post">
                                                @csrf
                                                @method('delete')
