                ...
                <div class="card-body">
                    ...
                    <form action="/app/room_category_facility" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="number" name="qty" class="form-control" placeholder="Number of Items"
                                required></input>
                        </div>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"
                                                    href="/app/room_category_facility/{{ $rcf->id }}/edit"><i
                                                        class="icon-base bx bx-edit-alt me-1"></i> Edit</a>
                                                <form action="{{ route('app.roomreservation.destroy', $rc->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
