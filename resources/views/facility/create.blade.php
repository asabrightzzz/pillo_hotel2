...
<h3 class="card-title h5 fw-bold text-gray-800">Add New Facilities</h3>
...
<div class="card-body">
    <form action="{{ route('app.facility.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="name" id="name" placeholder="Facility Name" value="{{ old('name') }}" required>
        </div>
        ...
        <div class="row g-3 mb-3">
            <div class="col-md-6">
                ...
                <select name="type" id="type" class="form-select" required>
                    ...
                    <option value="room" @if(old('type') === 'room') selected @endif>Room Facility</option>
                    <option value="public" @if(old('type') === 'public') selected @endif>Public Facility</option>
                </select>
            </div>
